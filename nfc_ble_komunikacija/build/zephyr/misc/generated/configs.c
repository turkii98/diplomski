...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_LLPM, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GATT_DM_LOG_LEVEL_DEFAULT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LATENCY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LATENCY_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LATENCY_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LATENCY_CLIENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LATENCY_CLIENT_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LATENCY_CLIENT_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_PARAM_ANY, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NFC_T4T_NDEF_FILE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NFC_PLATFORM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NFCT_IRQ_PRIORITY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NFC_THREAD_CALLBACK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NFC_RING_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NFC_LIB_CTX_MAX_SIZE, 16);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NFC_LOW_LATENCY_IRQ, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NFC_SWI_NUMBER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NFC_SWI1, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NFC_PLATFORM_LOG_LEVEL_DEFAULT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NFC_T4T_NRFXLIB, 1);
